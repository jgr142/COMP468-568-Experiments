...
============================================================
*/
void load_csr_from_edgelist(const std::string &filename, int &M, int &K,
...
void spmm_cpu(int M, int K, int N, const std::vector<int> &row_ptr,
              const std::vector<int> &col_idx, const std::vector<float_t> &vals,
